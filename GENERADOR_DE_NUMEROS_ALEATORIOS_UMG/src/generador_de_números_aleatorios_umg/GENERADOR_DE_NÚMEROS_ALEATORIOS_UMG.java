...
public class GENERADOR_DE_NÚMEROS_ALEATORIOS_UMG {
    ...
    public static void generar_numeros_aleatorios() {
        try {
            ...
            BufferedWriter escritorOrdenado = new BufferedWriter(new FileWriter("numeros_ordenados.txt"));
            ...
            System.out.println("su archivo fue guardado correctamente " + NUMEROS + " números aleatorios en el archivo.");
    ...
    public static void leerYOrdenarNumeros() {
        try {
            ...
            System.out.println("Su archivo fue guardado correctamente 'numeros_ordenados.txt'.");
